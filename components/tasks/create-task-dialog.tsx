          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <select 
                  name="priority"
                  className="w-full h-11 rounded-xl border border-input bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all appearance-none cursor-pointer"
                >
            ...
            <DialogFooter className="pt-4 border-t border-border/50">
              ...
              <Button type="submit" disabled={isLoading} className="shadow-lg shadow-primary/20 px-8">
